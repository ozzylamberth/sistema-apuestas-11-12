...
*/
     ...
     public void InsertarenBD (int maqId, String maqStatusxml) {
      ...
      try{
            ...
            System.out.println("ERROR, No se pudo seleccionar el ID de la maquina"+e.toString());
            logger.error("No se pudo seleccionar el ID de la maquina");
        }
        ...
        try {
            ...
            System.out.println("ERROR, No se pudo seleccionar el Id de la maquina");
            logger.error("No se pudo seleccionar el Id de la maquina");
        }
     return (maqIdQ);
}   

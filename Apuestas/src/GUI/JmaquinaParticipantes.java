 ...
 *
 * @author Eleany G
 * Esta interfaz grafica muesta un combobox con los participantes que participan en el evento seleccionado en la pantalla anterior
 *recibe el id del evento de la misma.
 * al seleccionar alguno muestra su descripcion y se puede apostar por el mismo, solo se puede apostar por un participante unico 
 * en cada apuesta, contiene las validaciones del tope de apuesta, ingresar un monto superior a 0, etc.
 *  inserta la apuesta realizada en la tabla apuesta y apu_par
 */
public class JmaquinaParticipantes extends javax.swing.JFrame {
    ...
    public JmaquinaParticipantes() {
     ...
     /** Creates new form JmaquinaParticipantes con el id del evento seleccionado en la interfaz anterior*/
    ...
    private void initComponents() {
        ...
        apostar.setBounds(30, 360, 380, 90);
        ...
        aceptar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/06.gif"))); // NOI18N
        ...
        aceptar.setBounds(550, 470, 260, 80);
        jLayeredPane2.add(aceptar, javax.swing.JLayeredPane.DEFAULT_LAYER);

        cancelar.setFont(new java.awt.Font("Comic Sans MS", 1, 28));
        ...
        cancelar.setBounds(950, 630, 110, 59);
        jLayeredPane2.add(cancelar, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/oro10.gif"))); // NOI18N
        jLabel7.setBounds(30, 560, 230, 140);
...
//Pantalla que valida si desea abandonar la apuesta y volver a la pantalla principal, al presionar el boton principal
 int respuesta= JOptionPane.showConfirmDialog(null,"Seguro que quiere abandonar esta apuesta?","Cancelar",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE,new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/47arw.gif"));
 //Si presiona NO,volvera ala pantella actual   
if (respuesta==1){
    
}
//Si presiona SI, es decir decide abandonar la apuesta, crea una instancia de Jmaquina, limpia las listas y cierra las conexiones
else{
...
if ( apuMonto.equals("")){
        JOptionPane.showMessageDialog(null, "Debe ingresar un monto para poder realizar la apuesta","Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif"));
...
if ((peTopeApuesta>0) && (apuestaMonto > peTopeApuesta)){
    JOptionPane.showMessageDialog(null, "No puede apostar por un monto mayor que el tope del participante","Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif"));
}
    ...
    if (apuestaMonto==0 ){
        ...
        //Selecciono el id de la maquina
    ...
    //Pantalla que valida si desea realizar una apuesta nueva de este mismo evento o finalizar 
    int respuesta= JOptionPane.showConfirmDialog(null,"Desea Realizar otra apuesta de este evento?","Se ha registrado su apuesta exitosamente",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/11.gif") );
//Si presiona NO, regresa a la pantalla principal (Jmaquina), limpia las listas y cierra las conexiones
    if (respuesta==1){
    Categoria cat = new Categoria();
ParEve pe = new ParEve();
Participante par = new Participante();
...
System.out.println("limpie las listas");
    ...
    //Si presiona que si, crea una nueva instancia de la interfaz JmaquinaParticipante con el id del evento antes seleccionado
else{
...
//Boton apostar, luego de seleccionar el particpante, hace visible los campos para colocar la apuesta

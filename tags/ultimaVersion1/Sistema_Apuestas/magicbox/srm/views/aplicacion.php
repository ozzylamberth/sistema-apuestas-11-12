...
<!-- 
@autor Irene
Vista o interfaz grafica utilizada al ingresar a la aplicacion como administrador-->
<body>
	<h1> 
		<span class="Estilo2" align="center"><span class="Estilo2" align="center">
			...
			<META HTTP-EQUIV="REFRESH" CONTENT="4;URL=?controlador=Home&accion=menuOperativo">  
			<b>
				<p align="center" class="Estilo1">
					<strong>
						<font color="#FFFFFF" face="verdana" size=4>Ingresando al Sistema Por Favor espere...</font>
					</strong>
				</p>
		</span>
	</h1>

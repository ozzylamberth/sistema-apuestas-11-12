<html>
<!-- Vista o interfaz grafica utilizada al mostrar las maquinas inactivas-->  
	<head>  
				...
				<table  width="900" border="0">
					...
					<tr>
						<td width="400" class="maps" align="center" colspan="2">
							Las Siguientes Maquinas se encuentran inactivas &nbsp; <img src="Imagenes/gmaps.png" width="32" height="32" alt="gmaps">
						</td>
                    ...
                    <tr>
						<td width="400" class="maps" align="center" colspan="2">
							No hay registros de m&aacute;quinas inactivas en el sistema!!!
						</td>
						<!--td width="100" bordercolor="#000000"><img src="Imagenes/gmaps.png" width="32" height="32" alt="gmaps"></td-->
					</tr>

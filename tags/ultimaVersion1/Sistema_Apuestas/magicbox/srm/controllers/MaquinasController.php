<?php
/* Controlador de maquinas contiene las invocaciones al modelo, escrituras en el LOG */
class MaquinasController
{
	...
	// funcion que instancia a la plantilla de agregar maquina
	...
	// funcion que lista las maquinas
	...
	public function listarMaquinasInactivas()
	{
		...
		try
		{
			...
			$maquinas=$modeloMaquinas->listarMaquinasInactivas();
			$data['maquinas']=$maquinas;
		...
		//Finalmente presentamos nuestra plantilla
		$this->view->show("mostrar_maquinas_inactivas.php", $data);
	}
	
	// Esta es la funcion que recibe los valores e inserta la maquina en la BD, llama a las funciones que lo haran
	public function agregarMaquina_2()
	{
		...
		try
		{
			...
			else
			{
				...
				$log->warn("Se ha intentado guardar una nueva maquina con campos en blanco!!!");
	...
	// funcion que muestra en el combobox de la plantilla las maquinas
	...
	// funcion que desactiva las maquinas, contiene escritura en los LOG

<!--
@autor Irene 
 Vista o interfaz grafica que se despliega al exportar el archivo XML-->
...
<body>
	...
	<form id="formulario" name="formulario" method="post" action="?controlador=Xml&accion=ExportarXml">
		...
		<center>
        	...
        	<INPUT type="hidden" name="direccion" id="direccion" value="<?Php echo trim($ruta); ?>" size="75px">
			...
			<table width="600" border="0" align="center">
                ...
                <tr>
					<th scope="col" colspan="2">
						<strong>Para generar el archivo XML presione el boton "Continuar"</strong>
						</br>
					</th>
				</tr>
				<tr>
                 ...
                 <?Php else: ?>
                    <tr>
                        <th scope="col" colspan="2">
                            <strong>Para descargar el archivo XML generado presione el boton "Descargar"</strong>
                            </br>
                        </th>
                    </tr>
                    <tr>
                        <th scope="col" colspan="2">	
                            <input name="Continuar" type="submit" class="bot" id="Descargar" value="Descargar" align='center' onClick="enviar(document.getElementById('direccion').value,'descargar')">
                            &nbsp;&nbsp;
                            <!--input name="Resetear" type="submit" class="bot" id="Resetear" value="Resetear" align='center' onClick="enviar('','buscar')"-->
                            </br></br></br>
                        </th>

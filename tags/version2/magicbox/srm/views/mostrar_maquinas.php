			...
			<form action="" method="get" name="Maquinas" >
				...
				<input name="contador" id="contador"  type="hidden" value="<?php echo count($maquinas) ?>">	
					...
					<?php foreach($maquinas as $clave=>$valor):?>
						<input name="maquina_<?php echo $i ?>" id="maquina_<?php echo $i ?>"  type="hidden" value="<?php echo $valor['maq_marca'].' '.$valor['maq_modelo'].' '.$valor['maq_procesador'].' '.$valor['maq_cap_disco'] ?>">
						<input name="longitud_<?php echo $i ?>" id="longitud_<?php echo $i ?>"  type="hidden" value="<?php echo $valor['maq_longitud'] ?>">	
						<input name="latitud_<?php echo $i ?>" id="latitud_<?php echo $i ?>"  type="hidden" value="<?php echo $valor['maq_latitud'] ?>">	
					<?php $i++?>
				...
				<table width="200" height="154" border="0" align="left">
					<tr>
						<td height="150" background="Imagenes/stock-photo-3284558-note-paper.jpg"> 
							<div align="center" class="nota2">
								<p>&nbsp;</p>
								<p>Si desea ver la informacion de la maquina, haga doble click sobre el marcador correspondiente</p>
							</div>

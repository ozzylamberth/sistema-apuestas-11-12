 ...
 *
 * @author Eleany G
 * Esta interfaz grafica muesra un combobox con los participantes del evento seleccionado anteriormente, muestra una descripcion
 * de cada uno de ellos al seleccionarlor y la posibilidad de agregarlos a tabla de resultados del evento, segun la cantidad de ganadoree
 * del mismo, tiene las validaciones del tope de apuesta, asi como de la cantidad de ganadores, no dejar campos vacios, etc.
 .
 */
...
private Maquina manejadorRepositorioMaq = new Maquina();
    ...
    /** Creates new form JmaquinaTablaResultados con el id del evento anterior y el nro de ganadores del mismo*/
    ...
    private void initComponents() {
        ...
        jLabelTopA.setFont(new java.awt.Font("Comic Sans MS", 1, 24));
        ...
        jTableResult.setFont(new java.awt.Font("Comic Sans MS", 1, 24));
        ...
        agregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/add_group-64.png"))); // NOI18N
        ...
        agregar.setBounds(610, 270, 200, 70);
        ...
        apostar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/09.gif"))); // NOI18N
        ...
        apostar.setBounds(260, 580, 370, 90);
        ...
        cancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/button_cancel-64.png"))); // NOI18N
        ...
        cancelar.setBounds(930, 630, 160, 70);
        jLayeredPane1.add(cancelar, javax.swing.JLayeredPane.DEFAULT_LAYER);

        limpiar.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        limpiar.setForeground(new java.awt.Color(204, 204, 0));
        limpiar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Clear-64.png"))); // NOI18N
        ...
        limpiar.setBounds(690, 560, 160, 60);
        jLayeredPane1.add(limpiar, javax.swing.JLayeredPane.DEFAULT_LAYER);
...
private void agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarActionPerformed
     ...
     //Guardo lo que seleccione del combobox y parseo a string
      ...
      //While que recorre la tabla, para validar que se ingresen correctamente los participantes y la apuesta de cada uno
        
       while ((i<resta) && (r==false) && (contadorFila>0)){
           //Nombre del participante en la posicion i de la tabla
       Object nombreValidar = jTableResult.getValueAt(i,0);  
      
  //Validacion de que no se agregue un participante repetido
       if (nombreValidar.equals(parNombre)){
         JOptionPane.showMessageDialog(null, "Participante "+parNombre+" ya agregado. Por favor Seleccione otro participante","Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif"));  
         r=true;
       }
       i++;
       }
     ...
     //Muestra un mensaje de error, en caso de que se desea ingresar un numero de participantes mayor al numero de ganadores del evento
     else{
         if (contadorFila>=eveNroGan){
         JOptionPane.showMessageDialog(null, "No puede agregar mas,el nro de ganadores de este evento es de"+eveNroGan,"Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif"));
         }
     }
   ...
   //Inicializo j y p 
    ...
    while (j<eveNroGan && p==false){
       ...
       if (nombreValidar == null){
             JOptionPane.showMessageDialog(null, "Debe ingresar "+eveNroGan+" particioantes","Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif"));
         ...
         JOptionPane.showMessageDialog(null, "No puede apostar sin colocar monto al participante ","Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif"));
         //cambia el valor p para que salga del while, al ocurrirse el error
         p= true;
       }
          else{
             ...
             // transformo el monto de la tabla en float
              ...
              if ((parTopApuestaValidar>0) && (montoValidarFloat>parTopApuestaValidar)){
                JOptionPane.showMessageDialog(null, "No puede realizar una apuesta mayor al Tope de apuesta del participante "+nombreValidarString,"Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif"));  
                p=true;
              }
...
System.out.println("limpie las listas");
        ...
        if ((j<eveNroGan) && (p==false)){
         JOptionPane.showMessageDialog(null, "Debe Ingresar "+eveNroGan+" participantes","Error", JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/v-k-s_10.gif")); 
        }
    }
    // TODO add your handling code here:
...
int respuesta= JOptionPane.showConfirmDialog(null,"Seguro que quiere abandonar esta apuesta?","Cancelar",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE, new ImageIcon("C:/Users/Eleany G/Documents/NetBeansProjects/ApuestasconPD/src/GUI/47aw.gif"));
 //Si presiona NO, vuelve a la pantalla actual   
if (respuesta==1){
    
}
//Si presiona SI, crea una instancia de Jmaquina (pantalla principal), limpia las listas y cierra las conexiones
else{

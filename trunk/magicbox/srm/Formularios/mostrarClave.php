    ...
    <body>   
        <center>
            <font color="#000000" face="verdana">
                ...
                <form name="respuestaSecreta" id="formPreguntaSecreta"  method="post" action="../Formularios/Guardarclave.php">
                    <table border="0">
                        <tr>
                            <td>Contrasena: </td>
                        ...
                        <tr>
                            <td><input id="cedula" type="hidden" value="<?php echo $admin_cedula ?>" name="cedula"/></td>
                        </tr>
                        <tr>

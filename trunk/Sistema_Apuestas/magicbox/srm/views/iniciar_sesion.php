...
<!-- 
@ Eleany G
Vista o interfaz grafica utilizada cuando el administrador  iniciar sesion -->
...
<body>
<form id="formulario" name="formulario" method="post" action="?controlador=Home&accion=autenticarse" target='_blank'>
	<div id="head">
    	<div id="title"></div>
    </div>
    <div id="body_wrapper">
		...
		<font color="#000000" face="verdana">
                	<div class="content"><BR><h2><p align="center">Bienvenido al Sistema de Apuestas</p></H2><p align="center"><p align="center">Por favor ingrese sus datos para acceder al sistema</p><br />
                    	<table width="348" border="0" align="center">
                            ...
                            <tr>
                                <td colspan="3"><a href="?controlador=Home&accion=recuperarClave"><h5 align="center">&#191; Olvidaste tu Contrase&ntilde;a ?</h5></a></td>

<?php
/*
Modelo de Categorias, contiene el listado, insercion, modificaciones y eliminaciones de las categorias 
*/
...
class CategoriasModel
{
	...
	// funcion que ingresa las categorias
	...
	// funcion que modifica el nombre de la categoria, al pasarle el id de la misma
	...
	// Funcion que elimina las categorias por el ID
	...
	// Funcion que busca las categorias que no estan asociadas a  eventos para eliminarlas ya que solo esas se pueden borrar
	...
	// Funcion que busca el nombre de las categorias por Id 
	...
	// funcion que busca los datos de los eventos inactivos
	...
	// Funcion que busca los eventos por Id
	...
	// Funcion que busca los ganadores de un evento
	...
	// funcion que busca los participantes de un evento
